...
**Progreso de la hoja de ruta: 106 de 180 tareas.**

| Región | Líneas | Estaciones | Trenes actuales | Trenes históricos |
|---|--:|--:|--:|--:|
| Shinkansen 新幹線 | 10 | 118 | 12 | 8 |
| Tokio 東京 | 138 | 1659 | 63 | 23 |
| Kioto 京都 | 36 | 431 | 20 | 2 |
| Ōsaka 大阪 | 61 | 705 | 14 | 0 |
| Kōbe 神戸 | 27 | 315 | 2 | 1 |
| Nagoya 名古屋 | 33 | 531 | 6 | 1 |
| Fukuoka 福岡 | 25 | 369 | 4 | 0 |
| Sapporo 札幌 | 9 | 121 | 13 | 3 |
| Sendai 仙台 | 5 | 84 | 2 | 0 |
| Hiroshima 広島 | 17 | 268 | 4 | 0 |
| Tranvías de otras ciudades 路面電車 | 27 | 350 | 4 | 0 |
| **Total** | **388** | **4877** | **144** | **38** |

- Fotos de trenes: **182 de 182** (100 %).
- Estaciones con datos curiosos: **68 de 4877** (1 %).
- Datos curiosos en total: **516**.
...
**5109 de 9619 estaciones de Japón (53 %).** Una prefectura está completa cuando no le falta ninguna.
...
| JO | [JR Sōbu (Chiba–Chōshi)](https://japanrail.alvaroom.org/#/line/sobu-main) | JR East | 33 | — | — | 1 |
...
| JI | [JR Kururi](https://japanrail.alvaroom.org/#/line/kururi) | JR East | 15 | — | — | 1 |
...
| CA | [JR Tōkaidō (Toyohashi–Ōgaki)](https://japanrail.alvaroom.org/#/line/tokaido-aichi) | JR Central | 58 | — | — | 1 |
...
| KC | [Meitetsu Kōwa](https://japanrail.alvaroom.org/#/line/meitetsu-kowa) | Meitetsu | 25 | — | — | 0 |
| TT | [Meitetsu Toyota](https://japanrail.alvaroom.org/#/line/meitetsu-toyota) | Meitetsu | 9 | — | — | 1 |
| E | [Kintetsu Nagoya](https://japanrail.alvaroom.org/#/line/kintetsu-nagoya) | Kintetsu | 53 | — | — | 0 |
...
| Código | Línea | Operador | Est. | Trenes actuales | Históricos | Datos |
|---|---|---|--:|---|---|--:|
| JA | [JR Kagoshima (Mojikō–Ōmuta)](https://japanrail.alvaroom.org/#/line/kagoshima-main-fukuoka) | JR Kyushu | 74 | — | — | 1 |
...
| JC | [JR Sasaguri](https://japanrail.alvaroom.org/#/line/sasaguri) | JR Kyushu | 13 | — | — | 0 |
...
| Código | Línea | Operador | Est. | Trenes actuales | Históricos | Datos |
|---|---|---|--:|---|---|--:|
| G | [JR Sanyō (Itozaki–Ōtake)](https://japanrail.alvaroom.org/#/line/sanyo-hiroshima) | JR West | 60 | — | — | 1 |
...
### Fase 3b · Completar las ciudades de la fase 3 (3/13)
...
### Fase 3c · Japón, prefectura a prefectura (12/47)
