...
> Generado automáticamente por `tools/inventory.py` a partir de los datos (2026-09-24). No lo edites a mano: cambia `config/` y vuelve a generar.

## Resumen

**Progreso de la hoja de ruta: 114 de 180 tareas.**
...
| Shikoku 四国 | 16 | 351 | 1 | 0 |
| Kyūshū y Okinawa 九州・沖縄 | 46 | 771 | 5 | 0 |
| **Total** | **428** | **5777** | **144** | **38** |

- Fotos de trenes: **182 de 182** (100 %).
- Estaciones con datos curiosos: **82 de 5777** (1 %).
- Datos curiosos en total: **610**.

## Cobertura de Japón

Todas las estaciones que OpenStreetMap tiene en cada prefectura, comparadas con las nuestras (`tools/audit_coverage.py`, 2026-09-24).

**5824 de 9573 estaciones de Japón (61 %).** Una prefectura está completa cuando no le falta ninguna.
...
### Fase 3c · Japón, prefectura a prefectura (18/47)
