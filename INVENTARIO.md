...
**Progreso de la hoja de ruta: 88 de 174 tareas.**

| Región | Líneas | Estaciones | Trenes actuales | Trenes históricos |
|---|--:|--:|--:|--:|
| Shinkansen 新幹線 | 10 | 118 | 12 | 8 |
| Tokio 東京 | 126 | 1504 | 63 | 23 |
| Kioto 京都 | 28 | 374 | 20 | 2 |
...
| **Total** | **317** | **3891** | **144** | **38** |

- Fotos de trenes: **182 de 182** (100 %).
- Estaciones con datos curiosos: **68 de 3891** (2 %).
- Datos curiosos en total: **456**.
...
**4255 de 9637 estaciones de Japón (44 %).** Una prefectura está completa cuando no le falta ninguna.
...
| M | [Tango: línea Miyamai](https://japanrail.alvaroom.org/#/line/tango-miyamai) | Kyōto Tango Tetsudō | 6 | — | — | 1 |
...
### Fase 2b · Completar Tokio y Kansai (huecos detectados) (25/29)
...
### Fase 3c · Japón, prefectura a prefectura (6/47)
